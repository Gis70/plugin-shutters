...
function displayCommandsPanels(_eqLogic) {
    ...
    switch (_eqLogic.configuration.eqType) {
        ...
        case 'shutter':
            ...
            div += '<a data-toggle="collapse" data-parent="#cmdPanel" href="#cmdPanel1"> {{Commandes de gestion conditions externes}} </a>';
            div += '</h4>';
            div += '</div>';
            ...
            div += '<div class="panel-heading">';
            div += '<h4 class="panel-title">';
            div += '<a data-toggle="collapse" data-parent="#cmdPanel" href="#cmdPanel2"> {{Commandes de statut des gestions conditions externes}} </a>';
            div += '</h4>';
            div += '</div>';
            ...
            div += '<div class="panel-heading">';
            div += '<h4 class="panel-title">';
            div += '<a data-toggle="collapse" data-parent="#cmdPanel" href="#cmdPanel4"> {{Commandes de statut des gestions conditions héliotrope}} </a>';
            div += '</h4>';
            div += '</div>';
            div += '<div id="cmdPanel4" class="panel-collapse collapse">';
            div += '<div class="panel-body">';
            div += '<table class="table table-bordered" data-cmdgroup="heliotropeZone" data-cmdtype="info">';
            div += '<thead>';
            div += '<tr>';
            div += '<th style="width: 50px;">{{Id}}</th>';
            div += '<th style="width: 200px;">{{Nom}}</th>';
            ...
            div += '<div class="panel-heading">';
            div += '<h4 class="panel-title">';
            div += '<a data-toggle="collapse" data-parent="#cmdPanel" href="#cmdPanel5"> {{Commandes de gestion du volet}} </a>';
            div += '</h4>';
            div += '</div>';
            div += '<div id="cmdPanel5" class="panel-collapse collapse">';
            div += '<div class="panel-body">';
            div += '<table class="table table-bordered" data-cmdgroup="shutter" data-cmdtype="action">';
            div += '<thead>';
            div += '<tr>';
            div += '<th style="width: 50px;">{{Id}}</th>';
            div += '<th style="width: 200px;">{{Nom}}</th>';
            ...
            div += '<div class="panel-heading">';
            div += '<h4 class="panel-title">';
            div += '<a data-toggle="collapse" data-parent="#cmdPanel" href="#cmdPanel6"> {{Commandes de statut du volet}} </a>';
            div += '</h4>';
            div += '</div>';
            div += '<div id="cmdPanel6" class="panel-collapse collapse">';
            div += '<div class="panel-body">';
            div += '<table class="table table-bordered" data-cmdgroup="shutter" data-cmdtype="info">';
            div += '<thead>';
            div += '<tr>';
            div += '<th style="width: 50px;">{{Id}}</th>';
            div += '<th style="width: 200px;">{{Nom}}</th>';
            ...
            $('table[data-cmdgroup=heliotropeZone][data-cmdtype=action]').sortable({items: ".cmd", axis: "y", tolerance: "intersect", containment: "table[data-cmdgroup=externalConditions][data-cmdtype=action]", placeholder: "ui-state-highlight", forcePlaceholderSize: true, cursor: "move"});
            $('table[data-cmdgroup=heliotropeZone][data-cmdtype=info]').sortable({items: ".cmd", axis: "y", tolerance: "intersect", containment: "table[data-cmdgroup=externalConditions][data-cmdtype=info]", placeholder: "ui-state-highlight", forcePlaceholderSize: true, cursor: "move"});
            $('table[data-cmdgroup=shutter][data-cmdtype=action]').sortable({items: ".cmd", axis: "y", tolerance: "intersect", containment: "table[data-cmdgroup=externalConditions][data-cmdtype=action]", placeholder: "ui-state-highlight", forcePlaceholderSize: true, cursor: "move"});
            $('table[data-cmdgroup=shutter][data-cmdtype=info]').sortable({items: ".cmd", axis: "y", tolerance: "intersect", containment: "table[data-cmdgroup=externalConditions][data-cmdtype=info]", placeholder: "ui-state-highlight", forcePlaceholderSize: true, cursor: "move"});
